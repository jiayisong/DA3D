_base_ = './rtmdet-3d_base_newloss_trainval.py'
...
checkpoint = './model_weight/cspnext-m_imagenet_600e_channel-4.pth'
# ========================modified parameters======================
work_dir = '/mnt/jys/mmyolo/work_dirs/medium_259/'
...
model = dict(
    ...
    neck=dict(deepen_factor=deepen_factor, widen_factor=widen_factor, deform_cat=False),
