...
from cv_ops.grid_sample_deterministic import ModulatedDeformConv2dFastv2Pack


@MODELS.register_module('DCNv2_deterministic')
class DCNv2_deterministic(ModulatedDeformConv2dFastv2Pack):
    pass
    ...
    def __init__(
        ...
        for i in range(1, len(in_channels)):
            ...
            proj = ConvModule(
                ...
                padding=1,
                bias=True,
                conv_cfg=dict(type='DCNv2_deterministic') if self.use_dcn else None,
                norm_cfg=norm_cfg)
            node = ConvModule(
                out_channels,
                out_channels,
