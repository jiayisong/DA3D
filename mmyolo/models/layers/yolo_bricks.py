...
#
# import cv_ops.grid_sample_deterministic.grid_sample_deterministic as grid_sample_deterministic
#
#
# class DeformCat(BaseModule):
#     def __init__(
#             self,
#             in_channels: int,
#             groups: int,
...
#         super().__init__(init_cfg=init_cfg)
#         self.groups = groups
#         self.conv_offset = nn.Conv2d(in_channels, groups * 2, kernel_size=1, stride=1, padding=0, bias=True)
...
#         out = out.view([b * self.groups, 2, h, w])
#         o1, o2 = torch.chunk(out, 2, dim=1)
#         x_cood = torch.arange(0, w, device=o1.device)
#         o1 = o1 + x_cood.view(1, 1, 1, -1)
#         y_cood = torch.arange(0, h, device=o2.device)
#         o2 = o2 + y_cood.view(1, 1, -1, 1)
#         offset = torch.stack((o1, o2), dim=1)
#         offset = offset.view(b * self.groups, 2, -1)
#         y = grid_sample_deterministic(x, offset).view(b, c, h, w)
#         return y
