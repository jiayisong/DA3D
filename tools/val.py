...
def main():
    ...
    if args.json_prefix is not None:
        cfg_json = {
            ...
            'val_evaluator.outfile_prefix': args.json_prefix
        }
    ...
    if args.tta:
        ...
        if 'batch_shapes_cfg' in val_data_cfg:
            val_data_cfg.batch_shapes_cfg = None
        val_data_cfg.pipeline = cfg.tta_pipeline
